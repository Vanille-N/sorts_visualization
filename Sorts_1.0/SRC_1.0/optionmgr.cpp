...
void OptionMgr::updateOptions (int algorithm) {
    ...
    switch (algorithm) {
        ...
        case 1:
            ...
            m_menu->setItemData(2, "Ω(n log n) | Θ(n log n) | O(n log n) || O(log n)", Qt::ToolTipRole) ;
            break ;
        case 2:
        ...
        case 6:
            ...
            m_menu->setItemData(2, "Ω(n) | Θ(n log n) | O(n log n) || O(1)", Qt::ToolTipRole) ;
            break ;
        case 7:
            ...
            m_menu->setItemData(2, "Ω(n²) | Θ(n²) | O(n²) || O(n)", Qt::ToolTipRole) ;
